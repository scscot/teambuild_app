const Map<String, List<String>> statesByCountry = {
  ...
  'Cape Verde': ['Ilhas de Barlavento', 'Ilhas de Sotavento'],
  'Chile': [
  ...
  'Equatorial Guinea': ['Región Continental', 'Región Insular'],
  'Eritrea': [
    'Al Awsaţ',
    'Al Janūbĩ',
    'Ansabā',
  ...
  'Republic of Ireland': ['Connaught', 'Leinster', 'Munster', 'Ulster'],
  ...
  'Serbia': ['Kosovo-Metohija', 'Vojvodina'],
  'Seychelles': [
    'Anse Boileau',
    'Anse Etoile',
    'Anse Royale',
  ...
  'Turkmenistan': ['Ahal', 'Aşgabat', 'Balkan', 'Daşoguz', 'Lebap', 'Mary'],
  'Tuvalu': [
    'Funafuti',
    'Nanumanga',
    'Nanumea',
